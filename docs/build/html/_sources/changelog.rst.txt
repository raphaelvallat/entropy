...
a. Updated :py:func:`entropy.lziv_complexity` using integer arrays with `Numba` in `PR16 <https://github.com/raphaelvallat/entropy/pull/16>`_.
b. :py:func:`entropy.lziv_complexity` now maps strings to UTF-8 integer representations.
